_base_ = [
    ...
    '../../_base_/datasets/Coco-stuff10k_640_640_3.py' #,  #数据集配置  by FRC  CMMPNETVOC1024_3
...
model = dict(
    ...
    backbone=dict(
         init_cfg=dict(
             type='Pretrained',
             checkpoint='../data/pretrained_models/segNeXt/mscan_t.pth'
...
data = dict(samples_per_gpu=4, workers_per_gpu=4)   #samples_per_gpu为batch的size，即是多少个样本为一个batch
