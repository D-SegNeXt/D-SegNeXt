...
class NL34_LinkNet(BaseModule):
    def __init__(self, num_classes=1, num_channels=3):
        ...
        #self.finalconv3 = nn.Conv2d(32, num_classes, 3, padding=1)  #by FRC
    ...
    def forward(self, x):
        ...
        #out = self.finalconv3(out) #by FRC

        #return F.sigmoid(out)  #by FRC
        return [out]
