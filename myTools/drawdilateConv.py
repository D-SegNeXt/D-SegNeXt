#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2023/5/28 12:34
# @Author  : FlyingRocCui
# @File    : drawDailateComv.py
# @Description : 绘制膨胀卷积
#https://github.com/WZMIAOMIAO/deep-learning-for-image-processing/blob/master/others_project/draw_dilated_conv/main.py
...
def main():
    ...
    for index, dilated_r in enumerate(dilated_rates[::-1]):
        new_map = dilated_conv_all_map(m, r=dilated_r, k=3)
        m = new_map
