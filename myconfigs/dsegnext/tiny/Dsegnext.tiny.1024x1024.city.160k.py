...
model = dict(
    ...
    backbone=dict(#dcan_ex10_t
        init_cfg=dict(type='Pretrained', checkpoint='../data/pretrained_models/dsegNeXt/AttentionModuleK5D1259Cat_tiny.pth')),#'../data/pretrained_models/ImageNet17GsegNeXt/mscan.pth'
    decode_head=dict(
        type='LightHamHead',
